...
public class ExceptionHandlingMiddleware
{
    ...
    private static HttpStatusCode MapStatusCode(CatalogException exception)
    {
        return exception switch
        {
            ...
            InvalidProductHeightException => HttpStatusCode.BadRequest,
            InvalidProductWidthException => HttpStatusCode.BadRequest,
            InvalidProductCubageException => HttpStatusCode.BadRequest,
            InvalidProductWeightException => HttpStatusCode.BadRequest,
            InvalidProductOriginZipCodeException => HttpStatusCode.BadRequest,
