...
using Expedition.API.Middleware;
...
{
    builder.WebHost.UseUrls("https://localhost:5113", "http://localhost:5123");
}

builder.AddECommerceObservability("expedition-api");
...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(GetExpeditionByOrderIdHandler).Assembly));
